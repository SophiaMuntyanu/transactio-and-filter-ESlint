      ...
      <div className="App">
        ...
        <main className="App-body container">
          ...
          <table className="App-body-table table table-hover table-sm">
            <thead>
              <tr>
                <th scope="col" className="size-font">#</th>
                <th scope="col" className="size-font">Type</th>
                <th scope="col" className="size-font">Value</th>
                <th scope="col" className="size-font">Date</th>
              </tr>
            </thead>
            {
              this.state.filterTransactions.map(trans => (
                <tbody>
                  <tr key={trans.id}>
                    <th scope="row" className="size-font">{trans.id}</th>
